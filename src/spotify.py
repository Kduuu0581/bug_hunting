...
# Problema 1 está na função handle_user_input():
# ela não está chamando a função process_music_analysis()
# com os argumentos corretos.
# Problema 2 está na função get_most_...():
# ela não está retornando as músicas corretas.
